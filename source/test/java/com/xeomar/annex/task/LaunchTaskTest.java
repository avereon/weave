...
public class LaunchTaskTest extends TaskTest {
	...
	public void testExecute() throws Exception {
		List<TaskResult> results = new Program().runTasksFromString( UpdateTask.LAUNCH + " java" );
		assertTaskResult( results.get( 0 ), TaskStatus.SUCCESS, "java" );
	}

	@Test
	public void testExecuteFailure() throws Exception {
		List<TaskResult> results = new Program().runTasksFromString( UpdateTask.LAUNCH + " invalid" );
