...
public class LaunchTaskTest {
	...
	public void testExecute() throws Exception {
		TaskResult result = TaskResult.parse( new Program().runTasksFromString( UpdateFlag.LAUNCH + " java" ) );
	...
	public void testExecuteFailure() throws Exception {
		TaskResult result = TaskResult.parse( new Program().runTasksFromString( UpdateFlag.LAUNCH + " invalid" ) );
